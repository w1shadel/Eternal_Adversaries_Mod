...
public class ClientForgeEvents {
    ...
    /**
     * 指定された2つの座標を対角とする範囲ボックスのワイヤーフレームを描画するメソッド
     */
    private static void renderBox(PoseStack poseStack, BlockPos pos1, BlockPos pos2) {
        ...
        // AABB（範囲ボックス）を作成
        AABB box = new AABB(pos1, pos2).expandTowards(1, 1, 1); // ブロック全体を囲むように1ブロック分広げる

        // LevelRenderer.renderLineBoxを使ってワイヤーフレームを描画
        LevelRenderer.renderLineBox(poseStack, buffer, box, 1.0f, 0.8f, 0.2f, 1.0f); // 色 (R, G, B, A) - オレンジ色
